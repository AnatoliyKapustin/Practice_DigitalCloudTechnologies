...
{
    internal class DatParserProvider
    {
        ...
        public static async Task<ObservableCollection<FileInfo>> OpenTnef(StorageFile file, ObservableCollection<FileInfo> targetCollection)
        {
            ...
            try
            {
                ...
                message = DatParserProvider.ExtractTnefMessage(tnefReader);
        ...
        private static MimeMessage ExtractTnefMessage(TnefReader reader)
        {
            ...
            {
                DatParserProvider.ExtractAttachments(reader, builder);
            }
      ...
      /*  private static void test(TnefReader reader, MimeMessage message, BodyBuilder builder)
        {
            ...
            TnefPropertyReader tnefPropertyReader = reader.TnefPropertyReader;
             while (tnefPropertyReader.ReadNextProperty())
             {
                 text.Add(tnefPropertyReader.PropertyTag.Id.ToString());
            ...
            while (tnefPropertyReader.ReadNextProperty())
            {
                switch (tnefPropertyReader.PropertyTag.Id) //ReadReceiptRequested ConversationTopic SendMailEntryID 13327
                {
                    ...
                    case TnefPropertyId.EmailAddress:
                        ...
                        continue;
                    case TnefPropertyId.ClientSubmitTime:               ///DisplayTo //SenderName DisplayCc ReadReceiptRequested
                        if (tnefPropertyReader.PropertyTag != null)
                        {
